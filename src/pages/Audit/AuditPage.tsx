...
import { ShieldCheck, Search, Download, CheckCircle2, AlertCircle, Clock } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Track user activities, agent operations, and system-wide security events
          </p>
        </div>

        <button className="inline-flex items-center px-4 py-2 bg-slate-900 border border-slate-800 hover:bg-slate-800 text-slate-200 text-sm font-medium rounded-xl transition-all">
