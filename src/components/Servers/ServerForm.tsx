              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setParent('department', e.target.value)}
                    placeholder="Finance"
                  />
                </div>
              ...
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    title="Auto-fill Location, Dept, Owner, OS from parent"
                  >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 border-t border-gray-100 dark:border-gray-800/80">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setChild(child.id, { department: e.target.value })}
                            placeholder="Finance"
                          />
                        </div>
