...
import { Bell, AlertTriangle, CheckCircle, ShieldAlert, Sparkles, X } from 'lucide-react';
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2 text-slate-300 hover:text-white bg-slate-800/60 hover:bg-slate-800 border border-slate-700/60 rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 sm:w-96 bg-slate-900/95 border border-slate-700/80 rounded-xl shadow-2xl backdrop-blur-xl z-50 overflow-hidden text-slate-100">
          <div className="p-3.5 border-b border-slate-800 flex items-center justify-between bg-slate-950/60">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="text-xs px-2 py-1 bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 border border-cyan-500/30 rounded flex items-center gap-1 transition-colors"
